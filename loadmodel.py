...
logging.basicConfig(level=logging.INFO, filename="/ukp-storage-1/khammari/NaturalQuestionsShort-eval.txt", filemode='w', format='%(message)s')
logging.info(torch.cuda.is_available())
input_file="/ukp-storage-1/khammari/QA-Verification-Via-NLI/MetaQA2/evaluation/id-question-eval-spanbert-large-cased_SQuAD-spanbert-large-cased_TriviaQA-web-TriviaQA-web.jsonl"
output_path='/ukp-storage-1/khammari/QA-Verification-Via-NLI/MetaQA2/evaluation/nq-nli-eval-SQuAD+TriviaQA-web-TriviaQA-web.jsonl'
#############################################################################
