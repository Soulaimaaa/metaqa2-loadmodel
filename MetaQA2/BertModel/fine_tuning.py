...
#tokenized_datasets = tokenized_input.rename_column("label", "labels")
...
def compute_metrics(eval_pred):
    ...
    print("here are logits and labels",logits,labels)
...
trainer = Trainer(
    model=model,
    args=training_args,
    train_dataset=tokenized_input['train'].shuffle(seed=40),
    eval_dataset=tokenized_eval_input['train'].shuffle(seed=40),
    tokenizer=tokenizer,
...
trainer.save_model("./Bert10K_shuffledData")